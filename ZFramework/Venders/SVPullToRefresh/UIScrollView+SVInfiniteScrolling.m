...
- (void)scrollViewDidScroll:(CGPoint)contentOffset {
    //contentOffset.y <= 0 means pull
    //scrollView contentSize height < scrollView frame height，说明内容不足一页，无需上拉加载更多
    if (contentOffset.y <= 0 || self.scrollView.contentSize.height < self.scrollView.frame.size.height) {        return;
    }
